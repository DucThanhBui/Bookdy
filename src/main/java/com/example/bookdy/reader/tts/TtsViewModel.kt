...
import com.example.bookdy.reader.MediaService
import com.example.bookdy.reader.MediaServiceFacade
import com.example.bookdy.reader.ReaderInitData
import com.example.bookdy.reader.VisualReaderInitData
...
class TtsViewModel private constructor(
    ...
    companion object {
        ...
        operator fun invoke(
            ...
            return TtsViewModel(
                ...
                bookIdf = readerInitData.bookIdf,
    ...
    private suspend fun openSession(navigator: Navigator) {
        ...
        try {
            mediaServiceFacade.openSession(bookIdf, ttsNavigator)
        } catch (e: Exception) {
            ttsNavigator.close()
