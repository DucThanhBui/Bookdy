...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: com.example.bookdy.Application
            get() = application as com.example.bookdy.Application
        ...
        fun <N> openSession(
            ...
            navigator.currentLocator
                ...
                .onEach { locator ->
                    ...
                    app.bookRepository.saveProgression(locator, bookIdf)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as com.example.bookdy.Application).readerRepository
