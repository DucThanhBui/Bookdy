...
import com.example.bookdy.search.SearchFragment
...
class EpubReaderFragment : VisualReaderFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val readerData = readerViewModel.readerInitData as? EpubReaderInitData ?: run {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (readerViewModel.settings as UserPreferencesViewModel<EpubSettings, EpubPreferences>)
